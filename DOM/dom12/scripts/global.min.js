...
function stripeTables(){if(!document.getElementsByTagName)return!1;for(var a=document.getElementsByTagName("table"),b=0;b<a.length;b++)for(var c=!1,e=a[b].getElementsByTagName("tr"),d=0;d<e.length;d++)1==c?(addClass(e[d],"odd"),c=!1):c=!0}
...
function displayAbbreviations(){if(!document.getElementsByTagName||!document.createElement||!document.createTextNode)return!1;var a=document.getElementsByTagName("abbr");if(1>a.length)return!1;for(var b=[],c=0;c<a.length;c++){var e=a[c];if(!(1>e.childNodes.length)){e.getAttribute("title");var d=e.lastChild.nodeValue;b[d]=f}}a=document.createElement("dl");for(d in b){var f=b[d],c=document.createElement("dt"),e=document.createTextNode(d);c.appendChild(e);e=document.createElement("dd");f=document.createTextNode(f);
e.appendChild(f);a.appendChild(c);a.appendChild(e)}if(1>a.childNodes.length)return!1;b=document.createElement("h3");d=document.createTextNode("abbreviations");b.appendChild(d);d=document.getElementsByTagName("article");if(0==d.length)return!1;d=d[0];d.appendChild(b);d.appendChild(a)}addLoadEvent(stripeTables);addLoadEvent(highlightRows);addLoadEvent(displayAbbreviations);
function focusLabels(){if(!document.getElementsByTagName)return!1;for(var a=document.getElementsByTagName("label"),b=0;b<a.length;b++)a[b].getAttribute("for")&&(a[b].onclick=function(){var a=this.getAttribute("for");document.getElementById("id")&&document.getElementById(a).focus()})}addLoadEvent(focusLabels);
function resetFields(a){if(!Modernizr.input.placeholder)for(var b=0;b<a.elements.length;b++){var c=a.elements[b];"submit"!=c.type&&(c.placeholder||c.getAttribute("placeholder"))&&(c.onfocus=function(){var a=this.placeholder||this.getAttribute("placeholder");this.value==a&&(this.value=this.className="")},c.onblur=function(){""==this.value&&(this.className="placeholder",this.value=this.placeholder||this.getAttribute("placeholder"))},elemnet.onblur())}}
